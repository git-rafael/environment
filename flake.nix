{
  ...
  let
    ...
    mkContainerDerivation = { nixpkgs, home-manager, ... }: modulePath: x86_64-linuxPkgs.dockerTools.buildImage (x86_64-linuxPkgs.callPackage modulePath { inherit nixpkgs home-manager; });
